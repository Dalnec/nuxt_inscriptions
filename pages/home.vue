...
useHead({
  meta: [
    ...
    { hid: "author", name: "author", content: "Tooplate" },
  ],
  link: [
    {
      rel: "stylesheet",
    ...
    {
      rel: "stylesheet",
      href: "/css/tooplate-artxibition.css",
    },
  ],
  script: [
...
<template>
  <body>
            ...
            <div class="owl-show-events owl-carousel">
              <div class="item">
                <a href="event-details.html"
                  ><img src="https://pixabay.com/es/photos/audiencia-concierto-guitarra-1835431" alt=""
                /></a>
              </div>
              <div class="item">
                <a href="event-details.html"
        ...
        <div class="row">
          <div class="col-lg-9">
            <div class="left-content">
              ...
              <p>
                ArtXibition Event Template is brought to you by Tooplate website and it included total 7 HTML pages.
                ...
                <a href="event-details.html">event details</a>, <a href="tickets.html">tickets</a>, and
                <a href="ticket-details.html">ticket details</a>. You can feel free to modify any page as you like. If
                you have any question, please visit our
                <a href="https://www.tooplate.com/contact" target="_blank">Contact page</a>.
              </p>
              <br />
              <p>
                You can use this event template for your commercial or business website. You are not permitted to
                redistribute this template ZIP file on any template download website. If you need the latest HTML
                templates, you may visit <a href="https://www.toocss.com/" target="_blank">Too CSS</a> website that
                features a great collection of templates in different categories.
              </p>
            </div>
          </div>
          <div class="col-lg-3">
    ...
    <!-- *** Map ***-->
    <div class="map-image">
      <img src="public/images/map-image.jpg" alt="Maps of 3 Venues" />
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="venue-item">
              <div class="thumb">
                <img src="public/images/venue-01.jpg" alt="" />
              </div>
          ...
          <div class="col-lg-4">
            <div class="venue-item">
              <div class="thumb">
                <img src="public/images/venue-02.jpg" alt="" />
              </div>
              <div class="down-content">
                <div class="left-content">
                  <div class="main-white-button">
          ...
          <div class="col-lg-4">
            <div class="venue-item">
              <div class="thumb">
                <img src="public/images/venue-03.jpg" alt="" />
              </div>
              <div class="down-content">
                <div class="left-content">
                  <div class="main-white-button">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="event-item">
              <div class="thumb">
                <a href="event-details.html"><img src="public/images/event-01.jpg" alt="" /></a>
              </div>
              <div class="down-content">
          ...
          <div class="col-lg-4">
            <div class="event-item">
              <div class="thumb">
                <a href="event-details.html"><img src="public/images/event-02.jpg" alt="" /></a>
              </div>
              <div class="down-content">
          ...
          <div class="col-lg-4">
            <div class="event-item">
              <div class="thumb">
                <a href="event-details.html"><img src="public/images/event-03.jpg" alt="" /></a>
              </div>
              <div class="down-content">
